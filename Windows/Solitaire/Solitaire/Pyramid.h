...
#pragma once
//피라미드 카드게임 클래스로 추상클래스인 CCardGame클래스를 상속받는다.
class CPyramid : public CCardGame
{
public:
	CPyramid(void);							//기본생성자
	virtual ~CPyramid(void);				//소멸자
private:
	...
	CList<CCard,CCard&> m_AniList;			//애니메이션에 사용될 리스트
...
public:
	...
	void Animation(CDC* pDC);				//클리어시 애니메이션
